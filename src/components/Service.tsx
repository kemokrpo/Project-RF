...
const Service: React.FC<ServiceProps> = ({ title, description }) => {
  ...
  return (
    <section id="services" className="py-20 px-4 bg-gold text-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="service bg-yellow-500 p-6 rounded-lg shadow-lg hover:bg-gray-700 transition duration-300"
          >
